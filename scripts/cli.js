...
const contractABI = require("../artifacts/contracts/Interfacerift.sol/Interfacerift.json").abi;

program
    .name("interfacerift-cli")
    .description("CLI tool for Interfacerift smart contract")
    .version("1.0.0");
