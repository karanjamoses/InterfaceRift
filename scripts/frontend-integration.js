 ...
 * This file demonstrates how to integrate Interfacerift with a web frontend
 */

// For React/Vue/Angular applications
export class InterfaceriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new InterfaceriftClient(provider, contractAddress);
